...
* 课程信息 （大致安排）<br> 
  ...
  7.3 <a href="../teaching/DP_7_3.pdf" class="textlink" target="_blank">动态规划模型的建立与求解<br>
  7.4 <a href="../teaching/DP_7_4.pdf" class="textlink" target="_blank">动态规划在经济管理中的应用 <br>
  第十二章：对策论<br>
  12.1 引言<br>
  12.2 矩阵对策的基本理论<br>
  12.3 矩阵对策的解法<br>
